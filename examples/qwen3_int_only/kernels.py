...
def attention_i8v8_q15_16_gqa_fused(q_heads, kv_heads, seqlen, dim, block_m=32, block_n=64, score_shift=26, lut_scale=0.125):
    group = q_heads // kv_heads
    q_size = q_heads * dim
...
def attention_i8v8_q15_16_gqa_cache_fused(q_heads, kv_heads, seqlen, cache_len, dim, block_m=16, block_n=64, score_shift=26, lut_scale=0.125):
    group = q_heads // kv_heads
    kv_len = cache_len + seqlen
    q_size = q_heads * dim
